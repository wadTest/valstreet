...
public class AddUserToServer extends AsyncTask<Void, Void, String> {
    ...
    public AddUserToServer(Context c, String et_nameString, String et_phoneString, String et_emailString, String et_passwordString) {
        this.c = c;
...
//
//    public AddUserToServer(Context c, String et_nameString, String et_lastString,
//                           String et_phoneString, String et_emailString, String et_passwordString) {
//        this.c = c;
//        this.et_nameString = et_nameString;
...
//    }
//
//    public AddUserToServer(SignInActivity signInActivity, String et_nameString, String et_phoneString, String et_emailString, String et_passwordString) {
//    }
//
//    //    doInBackground คือ Method ที่ทำงานอยู่เบื้องหลัง
//    @Override
