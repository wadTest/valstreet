...
//                Check Space เมื่อไไหร่ก้ตาม ถ้า editT1..มัน equals กับความว่างเปล่า blool จะเป็น True (|| ไบร์ย  t or t =t , t or f = t, f or t = t, f or f =f)
                if (editT.equals("") || editT1.equals("") || editT2.equals("") || editT3.equals("") || editT4.equals("")) {
                    ...
                    MyAlert myAlert = new MyAlert(LoginActivity.this, "มีพื้นที่ว่าง", "โปรดกรอกข้อมูลทั้งหมดในช่องว่าง");
                    myAlert.myDialog();
                }
            }//onClick
        });//End buttonSave
...
//        Next to MenuActivity
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent textSigninIntent = new Intent(LoginActivity.this, MenuActivity.class);
                LoginActivity.this.startActivity(textSigninIntent);
            }
        });
...
//        Get Event การรับกิจกรรมจาก ตัวแปร (กดเพื่อลงทะเบียน)
        ...
        textSignin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent textSigninIntent = new Intent(LoginActivity.this, SignInActivity.class);
                LoginActivity.this.startActivity(textSigninIntent);
            }
        });//End textSign in
